...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionDelete_input_file_after_convert = QAction(MainWindow)
        self.actionDelete_input_file_after_convert.setObjectName(u"actionDelete_input_file_after_convert")
        self.actionDelete_input_file_after_convert.setCheckable(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionDelete_input_file_after_convert.setText(QCoreApplication.translate("MainWindow", u"Delete input file after convert", None))
